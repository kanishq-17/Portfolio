...
const SmallProjectCard = ({
  ...
  console.log(reactProjects, nodeProjects, nextProjects, projectTrackerIndex);
  ...
  return (
    <div className="project-small-cards flex flex-wrap items-start justify-start gap-x-5 gap-y-4 mt-10 ">
          ...
          >
            <div className="project-img relative h-84">
              ...
              <div className="flex items-center justify-between absolute bottom-2 w-full px-3">
                ...
                <button className="text-white text-xs rounded-md px-3 py-2 bg-transparent backdrop-blur-2xl cursor-pointer">
                  View Details
                </button>
              </div>
            </div>
          ...
          >
            <div className="project-img relative h-84">
              ...
              <div className="flex items-center justify-between absolute bottom-2 w-full px-3">
                ...
                <button className="text-white text-xs rounded-md px-3 py-2 bg-white/30 backdrop-blur-3xl cursor-pointer">
                  View Details
                </button>
              </div>
            </div>
